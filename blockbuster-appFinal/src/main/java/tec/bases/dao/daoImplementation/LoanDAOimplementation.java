...
/**
 * Implementación de la interfaz LoanDAO que proporciona métodos para acceder y manipular los datos de los préstamos en la base de datos.
 * Extiende la clase GenericDAOimplementation y proporciona implementaciones específicas de los métodos abstractos para convertir resultados de ResultSet a entidades Loan y viceversa.
 */
public class LoanDAOimplementation extends GenericDAOimplementation<Loan, Long> implements LoanDAO {
    ...
    // Métodos de la interfaz LoanDAO
    ...
    public void delete(Long id) throws SQLException {
        // Implementación del método delete si es necesario
    }
